            ...
            <div className="min-h-screen bg-app flex flex-col transition-colors">
                ...
                <nav className="bg-transparent w-full z-50">
                    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        <div className="flex flex-col sm:flex-row h-auto sm:h-20 items-center justify-center sm:justify-between py-4 sm:py-0 gap-4 sm:gap-0">
                            <Link href="/internships" className="flex items-center justify-center w-full sm:w-auto order-last sm:order-first mt-2 sm:mt-0">
                                <span
                            ...
                            <div className="flex gap-3 justify-center w-full sm:w-auto order-first sm:order-last px-2 flex-wrap">
